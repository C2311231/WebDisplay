...
class DiscoveryEngine(commons.BaseClass):
    def __init__(self, discovery_port: int = 5000, discovery_multicast_address: address = address("239.143.23.9")):
    ...
    def send_discovery(self):
        ...
        sock.setsockopt(socket.IPPROTO_IP, socket.IP_MULTICAST_TTL, 2)  # Set TTL to 2 for local network
        ...
        while True:
            ...
            sock.sendto(message, (self.discovery_multicast_address, self.discovery_port))
