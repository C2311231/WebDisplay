...
def register(system_manager):
    networking_manager = system_manager.get_system_module("networking")
    database_manager = system_manager.get_system_module("database")
    return "discovery", DiscoveryManager(system_manager.config, networking_manager, database_manager)