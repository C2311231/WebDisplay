"""
Criterion File for Event device
...
class Criterion:
    def __init__(self, device: Device, event: "event.Event") -> None:
...
class AlwaysCriterion(Criterion):
    def __init__(self, device: Device, event: "event.Event", value) -> None:
        super().__init__(device, event)
        self.name = "Always"
        self.value = value
...
class AllCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", criteria: list[Criterion]) -> None:
        super().__init__(device, event)
        self.name = "All"
...
class NotCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", criterion: Criterion) -> None:
        super().__init__(device, event)
        self.name = "Not"
...
class DateRangeCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", start_date: str, end_date: str) -> None:
        super().__init__(device, event)
...
class TimeRangeCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", start_time: str, end_time: str) -> None:
        super().__init__(device, event)
...
class DayOfWeekCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", day: str) -> None:
        super().__init__(device, event)
...
class BeforeTimeCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", before_time: str) -> None:
        super().__init__(device, event)
...
class AfterTimeCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", after_time: str) -> None:
        super().__init__(device, event)
...
class BeforeDateCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", before_date: str) -> None:
        super().__init__(device, event)
...
class AfterDateCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", after_date: str) -> None:
        super().__init__(device, event)
...
class BeforeWeekdayCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", before_weekday: int) -> None:
        super().__init__(device, event)
...
class AfterWeekdayCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", after_weekday: int) -> None:
        super().__init__(device, event)
...
class DurringWeekdayCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", weekday: int) -> None:
        super().__init__(device, event)
...
class DurringMonthCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", month: int) -> None:
        super().__init__(device, event)
...
class DurringDateCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", date: int) -> None:
        super().__init__(device, event)
...
class DurringDayCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", day: int) -> None:
        super().__init__(device, event)
...
class BeforeMonthCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", before_month: int) -> None:
        super().__init__(device, event)
...
class AfterMonthCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", after_month: int) -> None:
        super().__init__(device, event)
...
class AfterDayCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", after_day: int) -> None:
        super().__init__(device, event)
        self.name = "After Day"
...
class BeforeDayCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", before_day: int) -> None:
        super().__init__(device, event)
...
class SinceLastOccurenceCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", since_seconds: int) -> None:
        super().__init__(device, event)
...
class BeforeNthIterationCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", before_nth: int) -> None:
        super().__init__(device, event)
...
class AfterNthIterationCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", after_nth: int) -> None:
        super().__init__(device, event)
...
class NthIterationCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", nth: int) -> None:
        super().__init__(device, event)
...
class EveryNthIterationCriterion(Criterion):
    def __init__(self, device: Device,  event: "event.Event", every_nth: int) -> None:
        super().__init__(device, event)
