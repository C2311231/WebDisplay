...
import src.device_modules.screens.screen as screen
import src.device_modules.content.content.content as content
import src.device_modules.events.criteria.criterion as criteria
from datetime import datetime

class Event:
    def __init__(self, device: Device, name: str, screen: screen.Screen, content: content.Content, priority: int, criteria: list[criteria.Criterion]):
        self.device = device
        self.name = name
        self.screen = screen
