...
import src.device_modules.screens as device_manager_screen
from src.device_modules.browsers import BrowserManager
...
class ContentPublishedGoogleSlide(Content):
    def __init__(self, device: Device , slide_id: str, autostart: bool, loop: bool, delay: float):
        super().__init__(device)
