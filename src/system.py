...
class system:
    ...
    def load_modules(self):
        for _, module_name, _ in pkgutil.iter_modules(src.system_modules.__path__):
            module = importlib.import_module(f"{src.system_modules.__name__}.{module_name}")
