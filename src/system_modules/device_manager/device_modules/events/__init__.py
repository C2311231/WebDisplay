...
import src.system
import src.module
import src.system_modules.device_manager.device_modules.events.event as event
import src.system_modules.device_manager.device as device
import src.system_modules.device_manager.device_modules.content.content.content as content
from .criteria import criterion

class EventManager(src.module.module):
    def __init__(self, system: src.system.system, device: device.Device):
        self.system = system
        self.device = device
...
def register(system: src.system.system, device: device.Device) -> tuple[str, src.module.module]:
