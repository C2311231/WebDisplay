...
class UpdateManager(src.module.module):
    """Class to manage updates for the WebDisplay application."""
    
    def __init__(self, system: src.system.system, repo_url: str = REPO_URL, content_url: str = CONTENT_URL,  local_dir: str = LOCAL_DIR, archive_dir:str = ARCHIVE_DIR, branch: str = BRANCH):
        self.system = system
    ...
    def start(self):
        self.api_registar: src.api.api_register = self.system.get_module("api_registry")  # type: ignore
        return super().start()
